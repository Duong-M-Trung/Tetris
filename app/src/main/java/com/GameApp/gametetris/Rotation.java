...
public class Rotation {
    ...
    public Rotation(Marathon parent) {
        this.parent = parent;
        meventListen = parent;
    }
    ...
    public void rotateMove(Boolean rotateRight){
        ...
        if(parent.random != 3 && parent.canRotate && parent.notLose) {
                ...
                rounded = (point1.y + point2.y + point3.y + point4.y); // Divison error fixed
            ...
            point4.x -= roundedX;
            point4.y -= roundedY;
                if (rotateRight) { // Rotate Right system is working
                    if(parent.random != 4) {
                        pointTemp = point1.x;
                        point1.x = point1.y;
                ...
                } else { // Rotate Left system isn't working because it is rotation twice not once somehow
                    if (parent.random != 4) {
                        pointTemp = point1.y;
                        point1.y = point1.x;
                        point1.x = 0 - pointTemp;
